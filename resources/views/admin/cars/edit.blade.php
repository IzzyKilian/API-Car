        ...
        <form action="{{route('admin.cars.update', $car->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="transmisi" id="transmisi" class="form-control">
                    ...
                    <option {{$car->transmisi == 'auto' ? 'selected' : null}}value="auto">Auto</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control">
                    ...
                    <option {{$car->status == 'tidak_tersedia' ? 'selected' : null}}value="tidak_tesedia">Tidak Tersedia</option>
                </select>
            </div>
            
            <div class="form-group">
                <label for="deskripsi">Deskripsi</label>
                <textarea name="deskripsi" class="form-control" id="deskripsi" cols="30" rows="10">{{old('deskripsi',$car->deskripsi)}}</textarea>
            </div>
            <div class="form-group">
